...
#[cfg(not(test))]
pub const LATTICE_SIZE: usize = 100;
#[cfg(test)]
...
impl SettingsBuilder {
    ...
    pub fn new() -> SettingsBuilder {
        Self { beta: 0.0, boundary_conditions: BoundaryConditions::Periodic, site_initialisation: Initialisation::Uniform }
    }

    pub fn add_beta(&mut self, beta: f64) -> SettingsBuilder {
        self.beta = beta;
        Self { beta, boundary_conditions: self.boundary_conditions, site_initialisation: self.site_initialisation }
    }

    pub fn add_boundary_conditions(&mut self, boundary_conditions: BoundaryConditions) -> SettingsBuilder {
        self.boundary_conditions = boundary_conditions;
        Self { beta: self.beta, boundary_conditions, site_initialisation: self.site_initialisation }
    }
    ...
    pub fn add_site_initialisation(&mut self, site_initialisation: Initialisation) -> SettingsBuilder {
        ...
        Self { beta: self.beta, boundary_conditions: self.boundary_conditions, site_initialisation }
    }

    pub fn build(self) -> Settings {
        Settings { dimensions: DIMENSIONS, lattice_size: LATTICE_SIZE, beta: self.beta, boundary_conditions: self.boundary_conditions, site_initialisation: self.site_initialisation }
    }
}
